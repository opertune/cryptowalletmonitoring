...
class ContactController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        $formCoinbase = $this->createFormBuilder()
            ->add('button', SubmitType::class, ['label' => 'Coinase oauth2'])
            ->getForm();

        $formCoinbase->handleRequest($request);

        // COINBASE OAUTH2 CALL
        if ($formCoinbase->isSubmitted()) {
        ...
        if (isset($_GET['code'])) {
            ...
            $rep = $this->client->request(
                'POST',
                "https://api.coinbase.com/oauth/token?grant_type=authorization_code&code=$code&client_id=7a579cdeb47df9088f9b853e7f40a3ed0a6805ff4918f35027b62326a51a0361&client_secret=aafb132ce7b3d0b9bf1e13abc116a0ad625d08e622376b62546c2e3ea39f6ef2&redirect_uri=https://127.0.0.1:8000/en/contact"
            );
